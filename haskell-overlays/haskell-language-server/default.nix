...
in self: super: {
  ...
  hls-tactics-plugin = dontCheck (self.callHackage "hls-tactics-plugin" "1.5.0.1" {});
  ...
  hls-pragmas-plugin = dontCheck (self.callHackage "hls-pragmas-plugin" "1.0.1.1" {});
  hls-refine-imports-plugin = dontCheck (self.callHackage "hls-refine-imports-plugin" "1.0.0.2" {});
  hls-splice-plugin = dontCheck (self.callHackage "hls-splice-plugin" "1.0.0.6" {});
  hls-stylish-haskell-plugin = dontCheck (self.callHackage "hls-stylish-haskell-plugin" "1.0.0.4" {});
  ...
  implicit-hie-cradle = dontCheck (self.callHackage "implicit-hie-cradle" "0.3.0.5" {});
  ...
  ghc-lib-parser = dontCheck (self.callHackage "ghc-lib-parser" "8.10.7.20210828" {});
  ghc-lib = dontCheck (self.callHackage "ghc-lib" "8.10.7.20210828" {});
  hlint = dontCheck (self.callHackage "hlint" "3.2.8" {});

  ghc-exactprint = dontCheck (self.callHackage "ghc-exactprint" "0.6.4" {});
  uniplate = dontCheck (self.callHackage "uniplate" "1.6.13" {});
  ghc-lib-parser-ex = dontCheck (self.callHackage "ghc-lib-parser-ex" "8.10.0.23" {});
